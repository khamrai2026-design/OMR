...
class ThemeManager:
    ...
    THEMES: Dict[str, ThemeConfig] = {
        ...
        "emerald": ThemeConfig(
            ...
            secondary="#34d399",
            accent="#6ee7b7",
            bg_glass="rgba(240, 253, 250, 0.85)",
            border_glass="rgba(16, 185, 129, 0.2)",
            text_main="#064e3b",
            text_muted="#047857",
            success="#10b981",
            error="#ef4444",
            ...
            info="#0891b2",
            bg_light="#f0fdf4",
            bg_body="radial-gradient(circle at 0% 0%, rgba(16, 185, 129, 0.03) 0%, transparent 50%), radial-gradient(circle at 100% 100%, rgba(52, 211, 153, 0.03) 0%, transparent 50%), #f0fdf4"
        ),
        "amber": ThemeConfig(
            primary="#f59e0b",
            primary_dark="#d97706",
            secondary="#fbbf24",
            accent="#fcd34d",
            bg_glass="rgba(255, 251, 235, 0.9)",
            border_glass="rgba(245, 158, 11, 0.2)",
            text_main="#78350f",
            text_muted="#92400e",
            success="#10b981",
            error="#ef4444",
            ...
            info="#0891b2",
            bg_light="#fffbeb",
            bg_body="radial-gradient(circle at 0% 0%, rgba(245, 158, 11, 0.03) 0%, transparent 50%), radial-gradient(circle at 100% 100%, rgba(251, 191, 36, 0.03) 0%, transparent 50%), #fffbeb"
        ),
        "coral": ThemeConfig(
            primary="#ff6b6b",
            primary_dark="#ff5252",
            secondary="#ff8787",
            accent="#ffa5a5",
            bg_glass="rgba(255, 245, 245, 0.85)",
            ...
            info="#0891b2",
            bg_light="#fff5f5",
            bg_body="radial-gradient(circle at 0% 0%, rgba(255, 107, 107, 0.03) 0%, transparent 50%), radial-gradient(circle at 100% 100%, rgba(255, 165, 165, 0.03) 0%, transparent 50%), #fff5f5"
        ),
        "cyberpunk": ThemeConfig(
            ...
            secondary="#00ffff",
            accent="#00ff88",
            bg_glass="rgba(10, 0, 30, 0.85)",
            border_glass="rgba(236, 10, 255, 0.3)",
            text_main="#e0e0ff",
            text_muted="#a0a0ff",
            success="#00ff88",
            error="#ff0055",
            ...
            info="#00ffff",
            bg_light="#1a0030",
            bg_body="radial-gradient(circle at 0% 0%, rgba(236, 10, 255, 0.05) 0%, transparent 50%), radial-gradient(circle at 100% 100%, rgba(0, 255, 255, 0.05) 0%, transparent 50%), #0a001e"
        ),
        "teal": ThemeConfig(
            primary="#14b8a6",
            primary_dark="#0d9488",
            ...
            accent="#5eead4",
            bg_glass="rgba(240, 253, 250, 0.85)",
            border_glass="rgba(20, 184, 166, 0.2)",
            text_main="#134e4a",
            text_muted="#0d6e66",
            success="#10b981",
            error="#ef4444",
            ...
            info="#0891b2",
            bg_light="#f0fdfa",
            bg_body="radial-gradient(circle at 0% 0%, rgba(20, 184, 166, 0.03) 0%, transparent 50%), radial-gradient(circle at 100% 100%, rgba(45, 212, 191, 0.03) 0%, transparent 50%), #f0fdfa"
        ),
        "sky": ThemeConfig(
            primary="#0ea5e9",
            primary_dark="#0284c7",
            secondary="#38bdf8",
            accent="#7dd3fc",
            bg_glass="rgba(240, 249, 255, 0.85)",
            border_glass="rgba(14, 165, 233, 0.2)",
            text_main="#082f49",
            text_muted="#0c4a6e",
            success="#10b981",
            error="#ef4444",
            ...
            info="#0ea5e9",
            bg_light="#f0f9ff",
            bg_body="radial-gradient(circle at 0% 0%, rgba(14, 165, 233, 0.03) 0%, transparent 50%), radial-gradient(circle at 100% 100%, rgba(56, 189, 248, 0.03) 0%, transparent 50%), #f0f9ff"
        ),
    }
